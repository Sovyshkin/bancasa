  ...
  <header class="header">
    <div class="logo" @click="goHome()">
      <img
        ...
        :src="`https://admin.ban.casa${info.header_logo.url}`"
        alt=""
      />
      <img
        v-if="info.header_logo_2 && !isHomePage"
        :src="`https://admin.ban.casa${info.header_logo_2.url}`"
        alt=""
      />
    </div>
    ...
    <div class="actions desktop-actions">
      ...
      <img
        ...
        :src="`https://admin.ban.casa${info.header_search.url}`"
        alt="search"
        @click="toggleMobileMenu"
      />
      <img
        v-if="info.header_search_2 && !isHomePage"
        :src="`https://admin.ban.casa${info.header_search_2.url}`"
        alt="search"
        @click="toggleMobileMenu"
      />
      <img
        v-if="info.header_user && isHomePage"
        :src="`https://admin.ban.casa${info.header_user.url}`"
        alt="user"
      />
      <img
        v-if="info.header_user_2 && !isHomePage"
        :src="`https://admin.ban.casa${info.header_user_2.url}`"
        alt="user"
      />
      <img
        v-if="info.header_shop && isHomePage"
        :src="`https://admin.ban.casa${info.header_shop.url}`"
        alt="shop"
      />
      <img
        v-if="info.header_shop_2 && !isHomePage"
        :src="`https://admin.ban.casa${info.header_shop_2.url}`"
        alt="shop"
      />
    </div>
        ...
        <div class="mobile-menu__header">
          <div class="logo" @click="goHome()">
            <img
              ...
              :src="`https://admin.ban.casa${info.header_logo_mobile.url}`"
              alt=""
            />
          </div>
        </div>
